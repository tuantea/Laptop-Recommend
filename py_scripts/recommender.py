...
def get_top_10(df):
    ...
    return df[budget_bool & storage_bool & screen_bool & ram_bool].sort_values('total_score',ascending=False).head(10).sort_values('weight',ascending=False).head(10)
